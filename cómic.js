...
function CambioImagen(){
    imagen.setAttribute("src","imgs/fondo_cueva.png" );
...
function CambioEscena(){
    capitulo.setAttribute("src","imgs/laboratorio-1-gif.gif");
    botonrojo.classList.add('oculto')
    botonverde.classList.add('oculto')
    lampara.classList.add('oculto')
  /*  area.classList.add('oculto') */
...
function CambiarPaisaje(){
    escena2.setAttribute("src","imgs/pasado pasado.gif");
...
function CambiarEscena(){
    escena3.setAttribute("src","imgs/escena final.gif");
...
function CambiarEscenaa(){
    escena4.setAttribute("src","imgs/Fondo 5 animar.gif maxx y amadeoo.gif");
